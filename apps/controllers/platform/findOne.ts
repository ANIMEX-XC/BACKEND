...
import { findOnePlatformSchema } from '../../schemas/platformSchema' // Updated schema import
import logger from '../../utilities/logger'

export const findPlatform = async (req: any, res: Response): Promise<Response> => {
  const { error, value } = validateRequest(findOnePlatformSchema, req.params) // Updated schema validation
  ...
  try {
    ...
    logger.info('Platform found successfully')
